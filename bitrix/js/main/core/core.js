...
(function() {
    ...
    (function(BX) {
        ...
        */
        ...
        BX.submit = function(obForm, action_name, action_value, onAfterSubmit) {
            ...
            }, obForm['BXFormSubmit_' + action_name]), 10);
        };
        ...
        BX.util = {
            ...
            deleteFromArray: function(ar, ind) {
                return ar.slice(0, ind).concat(ar.slice(ind + 1));
            },
            insertIntoArray: function(ar, ind, el) {
                return ar.slice(0, ind).concat([el]).concat(ar.slice(ind));
            },
    ...
    (function(window) {
        ...
        BX.ajax.processRequestData = function(data, config) {
            ...
            try {
                if (!!config.jsonFailure) {
                    throw {
                        type: 'json_failure',
                        data: config.jsonResponse,
                        bProactive: config.jsonProactive
                    };
                }
        ...
        BX.ajax.processScripts = function(scripts, bRunFirst, cb) {
            ...
            var inlineScripts = scriptsInt.length > 0 ? function() {

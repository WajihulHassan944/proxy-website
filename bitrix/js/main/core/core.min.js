(function() {
    ...
    (function(e) {
        ...
        t.objectWithoutPropertiesLoose = I;
    ...
    (function(e) {
        ...
        var I = C("navigator", "userAgent") || "";
        var _ = i.process;
        var L = i.Deno;
        var M = _ && _.versions || L && L.version;
        var D = M && M.v8;
        var F, R;
        if (D) {
            F = D.split(".");
        ...
        var K = function(e, t) {
            var r, n;
            if (t === "string" && A(r = e.toString) && !k(n = u(r, e))) return n;
            if (A(r = e.valueOf) && !k(n = u(r, e))) return n;
            if (t !== "string" && A(r = e.toString) && !k(n = u(r, e))) return n;
        ...
        var Ee = i.document;
        var Te = k(Ee) && k(Ee.createElement);
        var Be = function(e) {
        ...
        var Ce = function(e) {
            if (k(e)) return e;
            throw Ne(ke(e) + " is not an object")
        };
        var Pe = i.TypeError;
        var Ie = Object.defineProperty;
        var _e = s ? Ie : function e(t, r, n) {
            Ce(t);
            r = Se(r);
            Ce(n);
            if (je) try {
            ...
            if ("get" in n || "set" in n) throw Pe("Accessors not supported");
        ...
        var Re = i.WeakMap;
        var He = A(Re) && /native code/.test(Fe(Re));
        var We = ae("keys");
        var ze = function(e) {
        ...
        var ft = r((function(e) {
            ...
            (e.exports = function(e, r, s, o) {
                ...
                return A(this) && r(this).source || Fe(this)
            }))
        }));
        var dt = Math.ceil;
        var pt = Math.floor;
        ...
        var Bt = function(e, t) {
            ...
            var i = [];
            var a;
            for (a in r) !le(Ge, a) && le(r, a) && Tt(i, a);
            while (t.length > n)
                if (le(r, a = t[n++])) {
                    ~Et(i, a) || Tt(i, a)
                }
        ...
        var Lt = function(e, t) {
            var r = Dt[Mt(e)];
            return r == Rt ? true : r == Ft ? false : A(t) ? a(t) : !!t
        };
        var Mt = Lt.normalize = function(e) {
            return String(e).replace(_t, ".").toLowerCase()
        };
        var Dt = Lt.data = {};
        var Ft = Lt.NATIVE = "N";
        ...
        var Cr = function(e) {
            return e !== undefined && (Ar.Array === e || Nr[kr] === e)
        };
        var Pr = ge("toStringTag");
        var Ir = {};
        Ir[Pr] = "z";
        var _r = String(Ir) === "[object z]";
        ...
        var Rr = _r ? S : function(e) {
            var t, r, n;
            return e === undefined ? "Undefined" : e === null ? "Null" : typeof(r = Fr(t = Mr(e), Lr)) == "string" ? r : Dr ? S(t) : (n = S(t)) == "Object" && A(t.callee) ? "Arguments" : n
        };
        var Hr = ge("iterator");
        var Wr = function(e) {
            if (e != undefined) return J(e, Hr) || J(e, "@@iterator") || Ar[Rr(e)]
        };
        var zr = i.TypeError;
        var Gr = function(e, t) {
            var r = arguments.length < 2 ? Wr(e) : t;
            if (q(r)) return Ce(u(r, e));
        ...
        var qr = function(e, t, r) {
            ...
            while (!(v = u(h, l)).done) {
                ...
                if (typeof p == "object" && p && P(Yr, p)) return p
            }
            return new Vr(false)
        };
        var Jr = i.String;
        ...
        var oi = function(e, t, r, n) {
            var i = mn(r);
            var a = _n(e);
            if (i + t > a.byteLength) throw qn(Hn);
            var s = _n(a.buffer).bytes;
        ...
        var ui = function(e, t, r, n, i, a) {
            var s = mn(r);
            var o = _n(e);
            if (s + t > o.byteLength) throw qn(Hn);
            var u = _n(o.buffer).bytes;
        ...
        var ki = vi.DataView;
        var Ni = ki.prototype;
        var Ci = b(Ai.prototype.slice);
        var Pi = b(Ni.getUint8);
        var Ii = b(Ni.setUint8);
        var _i = a((function() {
        ...
        var Wi = function(e, t) {
            Ce(e);
            if (k(t) && t.constructor === e) return t;
            var r = Di.f(e);
            var n = r.resolve;
            n(t);
            return r.promise
        ...
        var ra = function(e) {
            var t;
            return k(e) && ((t = e[ta]) !== undefined ? !!t : S(e) == "RegExp")
        };
        var na = function() {
            var e = Ce(this);
            var t = "";
        ...
        var ka = /()??/.exec("")[1] !== undefined;
        var Na = Xa || ka || Aa || ma || ba;
        if (Na) {
            Ea = function e(t) {
                var r = this;
                var n = wa(r);
            ...
            matchAll: function e(t) {
                ...
                if (t != null) {
                    if (ra(t)) {
                        ...
                        if (!~za(n, "g")) throw Ha("`.matchAll` does not allow non-global regexes")
                    }
                    if (Ua) return Ga(r, t);
                    a = J(t, _a);
                    if (a === undefined && Q && S(t) == "RegExp") a = Va;
                    if (a) return u(a, t, r)
                } else if (Ua) return Ga(r, t);
                i = Zr(r);
                s = new RegExp(t, "g");
                return Q ? u(Va, s, i) : s[_a](i)
            }
        });
        Q || _a in Ra || ft(Ra, _a, Va);
        var Ya = Math.floor;
        var qa = b("".charAt);
        var Ja = b("".replace);
        var Za = b("".slice);
        ...
        var Cs = function e(t) {
            if (!k(t)) return false;
            var r = Rr(t);
            return r === "DataView" || le(ks, r) || le(Ns, r)
        };
        var Ps = function(e) {
            if (!k(e)) return false;
            var t = Rr(e);
            return le(ks, t) || le(Ns, t)
        };
        var Is = function(e) {
            if (Ps(e)) return e;
        ...
        if (s && !le(bs, Ss)) {
            ...
            ps(bs, Ss, {
                get: function() {
                    return k(this) ? this[Es] : undefined
                }
            });
            for (Os in ks)
                if (i[Os]) {
        ...
        var so = function(e, t, r) {
            var n, i;
            if (Kt && A(n = t.constructor) && n !== r && k(i = n.prototype) && i !== r.prototype) Kt(e, i);
            return e
        };
        var oo = r((function(e) {
            var t = At.f;
            ...
            var N = function e(t, r, n) {
                r = Se(r);
                if (X(t, r) && k(n) && le(n, "value") && !le(n, "get") && !le(n, "set") && !n.configurable && (!le(n, "writable") || n.writable) && (!le(n, "enumerable") || n.enumerable)) {
                    t[r] = n.value;
                    return t
                }
                return o(t, r, n)
                ...
                e.exports = function(e, s, l) {
                    ...
                    if (!y) {
                        ...
                        A = s((function(e, t, r, n) {
                            vn(e, N);
                            return so(function() {
                                if (!k(t)) return new X(mn(t));
                                if (O(t)) return n !== undefined ? new X(t, Ys(r, p), n) : r !== undefined ? new X(t, Ys(r, p)) : new X(t);
                                if (S(t)) return B(A, t);
                                return u(Js, A, t)
                            }(), e, A)
                        }));
        ...
        var go = vo;
        var bo = I.match(/firefox\/(\d+)/i);
        var wo = !!bo && +bo[1];
        var xo = /MSIE|Trident/.test(I);
        var So = I.match(/AppleWebKit\/(\d+)\./);
        var Eo = !!So && +So[1];
        var To = i.Array;
        ...
        var Io = Po && Po.constructor && Po.constructor.prototype;
        var _o = Io === Object.prototype ? undefined : Io;
        var Lo = ct.PROPER;
        ...
        var su = b([].slice);
        var ou = /(?:ipad|iphone|ipod).*applewebkit/i.test(I);
        ...
        var Au = /ipad|iphone|ipod/i.test(I) && i.Pebble !== undefined;
        var ku = /web0s(?!.*chrome)/i.test(I);
        var Nu = Ae.f;
        var Cu = Ou.set;
    ...
    (function(e) {
        ...
        const X = {};
        const A = "main.bitrix.main.controller.loadext.getextensions";
        ...
        let me = function() {
            ...
            babelHelpers.createClass(e, null, [{
                ...
                value: function t() {
                    let r = "bx-core";
                    if (ve.hasClass(document.documentElement, r)) {
                        return
                    }
                    if (e.isIOS()) {
                        r += " bx-ios"
                    ...
                    ve.addClass(document.documentElement, r)
                }
            }, {
                ...
                value: function e(t, r = null) {
                    ...
                    if (i.isString(n) && i.isPlainObject(r)) {
                        Object.keys(r).forEach((e => {
                            ...
                            n = n.replace(t, (() => i.isNil(r[e]) ? "" : String(r[e])))
                        }))
                    }
                    return n
                }
        ...
        let ze = function() {
            ...
            babelHelpers.createClass(e, [{
                key: "getSchema",
                value: function e() {
                    return We.get(this).schema
                }
            }, {
                key: "setSchema",
                value: function e(t) {
                    We.get(this).schema = String(t);
                    return this
                }
            }, {
                key: "getHost",
                value: function e() {
                    return We.get(this).host
                }
            }, {
                key: "setHost",
                value: function e(t) {
                    We.get(this).host = String(t);
                    return this
                }
            }, {
                key: "getPort",
                value: function e() {
                    return We.get(this).port
                }
            }, {
                key: "setPort",
                value: function e(t) {
                    We.get(this).port = String(t);
                    return this
                }
            }, {
                key: "getPath",
                value: function e() {
                    return We.get(this).path
                }
            }, {
                key: "setPath",
                value: function e(t) {
                    if (!/^\//.test(t)) {
                        We.get(this).path = `/${String(t)}`;
                        return this
                    }
                    We.get(this).path = String(t);
                    return this
                ...
                key: "getQuery",
                value: function e() {
                    return Re(We.get(this).queryParams)
                }
            }, {
                key: "getQueryParam",
                value: function e(t) {
                ...
                key: "setQueryParam",
                value: function e(t, r = "") {
                    We.get(this).queryParams[t] = He(r);
                    return this
                }
            }, {
                key: "getQueryParams",
                value: function e() {
                    return { ...We.get(this).queryParams
                    }
                }
            }, {
                key: "setQueryParams",
                value: function e(t = {}) {
                    ...
                    We.get(this).queryParams = n;
                    return this
                }
            }, {
                key: "removeQueryParam",
                value: function e(...t) {
                    const r = { ...We.get(this).queryParams
                    };
                    t.forEach((e => {
                        if (e in r) {
                            delete r[e]
                    ...
                    We.get(this).queryParams = r;
                    return this
                }
            }, {
                key: "getFragment",
                value: function e() {
                    return We.get(this).hash
                }
            }, {
                key: "setFragment",
                value: function e(t) {
                    We.get(this).hash = String(t);
                    return this
                }
            }, {
                key: "serialize",
        ...
        let Ye = function(e) {
            ...
            function t(...e) {
                ...
                babelHelpers.classCallCheck(this, t);
                r = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(t).call(this, ...e));
                babelHelpers.defineProperty(babelHelpers.assertThisInitialized(r), "storage", new Ve);
                return r
            }
            return t
        }(Ue);
        ...
        babelHelpers.defineProperty(qe, "MemoryCache", $e);
        babelHelpers.defineProperty(qe, "LocalStorageCache", Ye);
                ...
                value: function e(t) {
                    if (i.isStringFilled(t)) {
                        ...
                        if (i.isDomNode(e)) {
                            const r = (() => {
                                try {
                                    return new Ze(JSON.parse(e.innerHTML))
                                } catch (e) {
                                    return new Ze
                                }
                            })();
        ...
        let dt = function() {
            ...
            babelHelpers.createClass(e, null, [{
                key: "register",
                value: function t(r, n = {}) {
                    const i = ct(this, e, pt).call(this, r);
                    if (!i) {
                        return null
                    }
                ...
                key: "unregister",
                value: function t(r) {
                    const n = ct(this, e, pt).call(this, r);
                ...
                key: "getComponent",
                value: function t(r) {
                    const n = ct(this, e, pt).call(this, r, true);
                    if (!n) {
                        return null
                    }
                    const i = this.getStack(n);
        ...
        babelHelpers.defineProperty(dt, "stacks", new WeakMap);
        var ht = {
            OrderedArray: st
        };
        ...
        const Nt = function e() {
            ve.addClass(...q.merge([], Array.from(arguments), [vt(arguments[0])]))
        };
        const Ct = function e() {
            ve.removeClass(...q.merge(Array.from(arguments), [vt(arguments[0])]))
        };
        const Pt = function e() {
            return ve.hasClass(...q.merge(Array.from(arguments), [vt(arguments[0])]))
        };
        const It = function e() {
            ve.toggleClass(...q.merge(Array.from(arguments), [vt(arguments[0])]))
        };
        const _t = (e, t = false) => {
            const r = vt(e);
            if (i.isDomNode(r)) {
        ...
        const Kt = { ...Object.getOwnPropertyNames(i).filter((e => !["name", "length", "prototype", "caller", "arguments"].includes(e))).reduce(((e, t) => {
                e[t] = i[t];
                return e
            }), {}),
        ...
        const er = window.BX ? window.BX.ajax : () => {};
        ...
        e.browser = Qt;
        e.ajax = er;
        e.GetWindowScrollSize = tr;
        e.GetWindowScrollPos = rr;
        e.GetWindowInnerSize = nr;
        e.GetWindowSize = ir;
        e.GetContext = ar;
        e.pos = sr;
        e.addCustomEvent = or;
        e.onCustomEvent = ur;
        e.removeCustomEvent = lr;
        e.removeAllCustomEvents = cr
    })(this.BX = this.BX || {});
    (function(BX) {
        ...
        function loadAsset(e, t, r) {
            ...
            var s;
            var o = BX.type.isNotEmptyString(e.ext) ? e.ext : BX.util.getExtension(e.url);
            if (o === "css") {
    ...
    (function(e) {
        ...
        t.ajax = function(e) {
            ...
            for (var s in r)
                if (typeof e[s] == "undefined") e[s] = r[s];
            r = {};
            for (s in n)
                if (typeof e[s] == "undefined") e[s] = n[s];
            e.method = e.method.toUpperCase();
            if (!t.localStorage) e.lsId = null;
            if (t.browser.IsIE()) {
                var l = o.url_utf.exec(e.url);
                if (l) {
                    do {
                        e.url = e.url.replace(l, t.util.urlencode(l));
                        l = o.url_utf.exec(e.url)
                    } while (l)
                }
            }
            ...
            if (c) {
                ...
                if (typeof e.headers == "object") {
                    for (s = 0; s < e.headers.length; s++) e.xhr.setRequestHeader(e.headers[s].name, e.headers[s].value)
                }
                var p = false;
        ...
        t.ajax.__prepareOnload = function(r) {
            if (r.length > 0) {
                ...
                for (var n = 0, a = r.length; n < a; n++) {
                    if (r[n].isInternal) {
                        r[n].JS = r[n].JS.replace(o.script_onload, "BX.ajax.onload_" + i)
                    }
                }
            }
            t.CaptureEventsGet();
        ...
        t.ajax.processRequestData = function(e, r) {
            ...
            switch (r.dataType.toUpperCase()) {
                case "JSON":
                    var o = r.xhr || {};
                    t.addCustomEvent(o, "onParseJSONFailure", t.proxy(t.ajax._onParseJSONFailure, r));
                    n = t.parseJSON(e, o);
                    t.removeCustomEvent(o, "onParseJSONFailure", t.proxy(t.ajax._onParseJSONFailure, r));
            ...
            if (s.length > 0) t.loadCSS(s);
            if (r.emulateOnload) t.ajax.__prepareOnload(a);
            var f = t.DoNothing;
            if (r.emulateOnload || c) {
                f = t.defer((function() {
        ...
        t.ajax.loadScriptAjax = function(e, r, n) {
            if (t.type.isArray(e)) {
                ...
                if (o.script_self.test(u)) return;
                if (o.script_self_window.test(u) && t.CWindow) return;
                if (o.script_self_admin.test(u) && t.admin) return;
        ...
        t.userOptions.save = function(e, r, n, i, a) {
            ...
            if (s != "") document.cookie = t.message("COOKIE_PREFIX") + "_LAST_SETTINGS=" + encodeURIComponent(s) + "&sessid=" + t.bitrix_sessid() + "; expires=Thu, 31 Dec " + ((new Date).getFullYear() + 1) + " 23:59:59 GMT; path=/;";
        ...
        t.ajax.history = {
            ...
            init: function(r) {
                ...
                if (t.ajax.history.bPushState) {
                    ...
                    d.put(t.ajax.history.expected_hash, n);

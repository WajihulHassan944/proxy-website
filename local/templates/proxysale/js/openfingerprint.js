    ...
    return void 0 === a && (a = 16), n(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t) {
            switch (t.label) {
                ...
                case 1:
                    return i < e.length ? (r(e[i], i), (c = Date.now()) >= n + a ? (n = c, [4, o(0)]) : [3, 3]) : [3, 4];
                case 2:
                    t.sent(), t.label = 3;
                case 3:
                    return ++i, [3, 1];
...
function h(e, n) {
    ...
    return a = l(a = f(a, [0, e.length]), i = f(i, [0, e.length])), i = l(i, a), a = l(a = v(a), i = v(i)), i = l(i, a), ("00000000" + (a[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (a[1] >>> 0).toString(16)).slice(-8) + ("00000000" + (i[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (i[1] >>> 0).toString(16)).slice(-8)
}
...
function S() {
    var e = window,
        n = navigator;
    return g(["msWriteProfilerMark" in e, "MSStream" in e, "msLaunchUri" in n, "msSaveBlob" in n]) >= 3 && !Z()
}
        ...
        function() {
            return n(e, void 0, void 0, (function() {
                ...
                return t(this, (function(n) {
                    switch (n.label) {
                        case 0:
                            return E(e = D()) ? N ? [2, r([], N, !0)] : C() ? [4, (t = document, (t.exitFullscreen || t.msExitFullscreen || t.mozCancelFullScreen || t.webkitExitFullscreen).call(t))] : [3, 2] : [3, 2];
                        case 1:
...
function B(e) {
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return t(this, (function(t) {
            switch (t.label) {
                case 0:
                    for (n = document, a = n.createElement("div"), i = new Array(e.length), c = {}, T(a), s = 0; s < e.length; ++s) u = I(e[s]), T(l = n.createElement("div")), l.appendChild(u), a.appendChild(l), i[s] = u;
                    t.label = 1;
                case 1:
...
var ne = {
    fonts: function() {
        return M((function(e, n) {
            ...
            r.appendChild(o);
            for (var s = 0; s < A.length; s++) a[A[s]] = u[s].offsetWidth, i[A[s]] = u[s].offsetHeight;
            return J.filter((function(e) {
                return n = l[e], A.some((function(e, t) {
            ...
            return t(this, (function(t) {
                switch (t.label) {
                    case 0:
                        ...
                        }, n = Object.keys(e), [4, B((i = []).concat.apply(i, n.map((function(n) {
                            return e[n]
                        }))))]) : [2, void 0];
                    case 1:
        ...
        return function(e, n) {
            ...
            return M((function(t, o) {
                var a = o.document,
                    i = a.body,
                    c = i.style;
                c.width = "".concat(n, "px"), c.webkitTextSizeAdjust = c.textSizeAdjust = "none", X() ? i.style.zoom = "".concat(1 / o.devicePixelRatio) : x() && (i.style.zoom = "reset");
                            ...
                            try {
                                ...
                                switch (a(r) && u(r), e.state) {
                                    case "running":
                                        ...
                                        break;
                                    case "suspended":
                                        document.hidden || d++, s && d >= n ? l(G("suspended")) : setTimeout(v, t)
                                }
                            } catch (o) {
                                l(o)
                            }
    ...
    languages: function() {
        ...
        if (void 0 !== r && t.push([r]), Array.isArray(n.languages)) X() && g([!("MediaSettingsRange" in (e = window)), "RTCEncodedAudioFrame" in e, "" + e.Intl == "[object Intl]", "" + e.Reflect == "[object Reflect]"]) >= 3 || t.push(n.languages);
    ...
    timezone: function() {
        ...
        var r, o = (r = (new Date).getFullYear(), -Math.max(p(new Date(r, 0, 1).getTimezoneOffset()), p(new Date(r, 6, 1).getTimezoneOffset())));
...
var ue = {
    ...
    le = h;
export {
    re as componentsToDebugString, ue as
    default, C as getFullscreenElement, z as getScreenFrame, oe as hashComponents, R as isAndroid, X as isChromium, F as isDesktopSafari, S as isEdgeHTML, Y as isGecko, Z as isTrident, x as isWebKit, ce as load, V as loadSources, le as murmurX64Hash128, ae as prepareForSources, ne as sources, W as transformSource
};